...
export const pricingPlans = [
  {
    id: 'catalogo-web',
    name: 'Catálogo Web + WhatsApp',
    narrative: 'Digitaliza tu negocio y recibe pedidos armados directamente en tu chat.',
    price: '2,500',
    currency: 'MXN',
    priceNote: 'pago único (50% anticipo / 50% entrega)',
    highlighted: false,
    features: [
      'Catálogo interactivo con fotos, precios y descripción',
      'Botón directo de "Pedir por WhatsApp"',
      'Optimizado para celulares y carga ultrarrápida',
      'Panel básico para actualizar productos y precios',
      'Soporte y garantía por 15 días',
    ],
    ctaLabel: 'Elegir Catálogo Web',
    whatsappMessage: 'Hola, me interesa contratar el paquete Catálogo Web de $2,500 MXN.',
  },
  {
    id: 'crm-gestion',
    name: 'CRM & Gestión de Pedidos',
    narrative: 'Controla tu inventario en tiempo real y evita perder ventas por WhatsApp.',
    price: '5,500',
    currency: 'MXN',
    priceNote: 'pago único (50% anticipo / 50% entrega)',
    highlighted: true,
    features: [
      'Todo lo incluido en el Catálogo Web',
      'Registro de "Intenciones de Compra" por WhatsApp',
      'Confirmación de pago en 1 clic para evitar ventas falsas',
      'Control de inventario en tiempo real con descuento automático',
      'Alertas de stock crítico e historial de clientes',
      'Soporte y acompañamiento por 30 días',
    ],
    ctaLabel: 'Elegir CRM & Gestión',
    whatsappMessage: 'Hola, me interesa contratar el paquete CRM & Gestión de $5,500 MXN.',
  },
  {
    id: 'crm-analitica',
    name: 'CRM & Analítica Avanzada',
    narrative: 'Predice tendencias de demanda y optimiza el margen neto de tu empresa.',
    price: '9,500',
    currency: 'MXN',
    priceNote: 'pago único (50% anticipo / 50% entrega)',
    highlighted: false,
    features: [
      'Todo lo incluido en el paquete CRM & Gestión',
      'Dashboard analítico (ticket promedio, hora/día moda de venta)',
      'Estadística inferencial y modelos de proyección de demanda',
      'Métricas de tasa de conversión (consultas vs. compras reales)',
      'Exportación de reportes operativos en tiempo real',
      'Acompañamiento estratégico personalizado por 30 días',
    ],
    ctaLabel: 'Elegir CRM Analítico',
    whatsappMessage: 'Hola, me interesa contratar el paquete CRM & Analítica Avanzada de $9,500 MXN.',
  },
];
