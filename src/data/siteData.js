...
export const pricingPlans = [
  {
    id: 'crm-basico',
    name: 'CRM Básico',
    narrative: 'Organiza tus clientes y controla tus pedidos.',
    price: '6,500',
    currency: 'MXN',
    ...
    ctaLabel: 'Elegir CRM Básico',
    whatsappMessage: 'Hola, me interesa contratar el paquete CRM Básico de $6,500 MXN.',
  },
  {
    id: 'crm-personalizado',
    name: 'CRM Personalizado',
    narrative: 'Garantiza entregas a tiempo y fideliza a tus clientes.',
    price: '13,500',
    currency: 'MXN',
    priceNote: 'pago único (50% anticipo / 50% entrega)',
    highlighted: true,
    features: [
      ...
      'Asistente de seguimiento postventa para WhatsApp',
      'Confirmación previa manual por el vendedor',
      'Alertas de control para entregas (1 a 5 días)',
      'Perfilador y sugeridor de productos complementarios',
      'Soporte y garantía por 30 días',
    ],
    ctaLabel: 'Elegir CRM Personalizado',
    whatsappMessage: 'Hola, me interesa contratar el paquete CRM Personalizado de $13,500 MXN.',
  },
  {
    id: 'crm-avanzado',
    name: 'CRM Avanzado',
    narrative: 'Predice ventas y analiza las tendencias de tu mercado.',
    price: '22,000',
    currency: 'MXN',
    priceNote: 'pago único (50% anticipo / 50% entrega)',
    highlighted: false,
